...
describe('Test data extraction from input', () => {
  ...
  it('Get data for supplied deployment-id', () => {
    getInput.returns(`{
    "IONOS_DEPLOYMENT_ff3f20ab5cd449c88424fef76d766229_DB_USER": "db-user",
    "IONOS_DEPLOYMENT_ff3f20ab5cd449c88424fef76d766229_DB_PASSWORD": "db-password",
    "IONOS_DEPLOYMENT_b486c8a2501f48b5b1bf2c3c75ccaf87_DB_USER": "db-user-2",
    "IONOS_DEPLOYMENT_b486c8a2501f48b5b1bf2c3c75ccaf87_DB_PASSWORD": "db-password-2",
  ...
  it('Show error, if data was empty', () => {
    ...
    expect(() => Data.fromInput('ff3f20ab-5cd4-49c8-8424-fef76d766229')).to.throw(
      'Property "data" was not supplied properly. Please add "data: ${{ toJson(secrets) }}" to the "with" section of this action.'
    );
  });
