...
describe('Test file and directory handling', () => {
  ...
  it('Create directory tree at output location', () => {
    ...
    Directory.openFromRepo('config', '.template').createDirectoryTreeAt('out');
  ...
  it('Save rendered templates at output location', () => {
    ...
    Directory.openFromRepo('config', '.template').forEachTemplateFile((templateFile) =>
      templateFile.renderWith((content) => 'Rendered ' + content).saveResultTo('out')
    );
  ...
  it('Update prepared templates at output location', () => {
    ...
    Directory.openFromRepo('config', '.template').forEachTemplateFile((templateFile) =>
      templateFile.renderWith((content) => 'Rendered ' + content).updateFile('out')
    );
