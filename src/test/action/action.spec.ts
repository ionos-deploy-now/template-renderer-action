...
describe('Test main action function', () => {
  ...
  it('Test prepare and complete', async () => {
    ...
    withDataInput({
      IONOS_MAIL_USER: 'mail-user',
      IONOS_MAIL_PASSWORD: 'mail-password',
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_USER: 'db-user',
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_PASSWORD: 'db-password',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_USER: 'db-user-2',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_PASSWORD: 'db-password-2',
    });
  ...
  it('Test full action', async () => {
    ...
    withDataInput({
      ...
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_USER: 'db-user',
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_PASSWORD: 'db-password',
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_URL: 'db://host.com',
      IONOS_DEPLOYMENT_29ed115b0e7e4f2789b050c6436d7d5e_DB_PORT: '4567',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_USER: 'db-user-2',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_PASSWORD: 'db-password-2',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_URL: 'db://host.com',
      IONOS_DEPLOYMENT_6f58389aab904070a2feb19d1a8a8e12_DB_PORT: '4567',
      secret_1: 'secure',
